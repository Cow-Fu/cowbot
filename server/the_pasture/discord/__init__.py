...
from the_pasture.protocol import CowpanionPasture
...
class DiscordPasture:
  def __init__(self) -> None:
    self.bot = commands.Bot(command_prefix=('Moo ', 'moo '))
    self.bot.add_cog(TTSBot(bot))
    self.wss = None

  def set_cowpanion_wss(self, wss: CowpanionPasture) -> None:
    self.wss = wss
